...
#endif
			ramdisk_read((void *)va_to_pa(vaddr),ELF_OFFSET_IN_DISK+ph->p_offset,ph->p_filesz);
			memset((void *)(va_to_pa(vaddr)+ph->p_filesz+ph->p_offset),0,ph->p_memsz-ph->p_filesz);
		}
	}
